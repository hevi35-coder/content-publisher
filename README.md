...
| 일요일 | 16:07 KST | Topic Selection |
| 화/목/토 | 16:07 KST | Draft + PR + Auto-Merge (EN: 목, KOR: 화/목/토) |
...
- `live_publish_confirm` 값은 Repository Secret `LIVE_PUBLISH_CONFIRM_TOKEN`과 정확히 일치해야 합니다.
...
- `PR Sanity` 워크플로우는 아래를 자동 검증합니다.
  ...
  - 스케줄 cron 가드레일(주간 16:07 KST, 스모크 00:40 KST)
